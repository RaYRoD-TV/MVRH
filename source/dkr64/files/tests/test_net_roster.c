...
int main(void) {
    ...
    assert(mdkr_net_roster_runtime_viewport_player(0u, 0u) == 0u);
    assert(mdkr_net_roster_runtime_canonical_player_count(1u) == 1u);
    assert(mdkr_net_roster_runtime_install(&spec, &b));
    assert(mdkr_net_roster_runtime_active());
    assert(mdkr_net_roster_runtime_viewport_player(0u, 0u) == 1u);
    assert(mdkr_net_roster_runtime_viewport_player(1u, 0u) == MDKR_NET_ROSTER_UNMAPPED);
    ...
    assert(mdkr_net_roster_runtime_viewport_player(0u, 0u) == MDKR_NET_ROSTER_UNMAPPED);
