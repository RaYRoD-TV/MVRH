...
static void test_presets(void) {
    ...
    expect_true("controller defaults preserve alternate B and trigger drift",
                !strcmp(cfg.values[MDKR_INPUT_CONTROLLER_B].text, "b") &&
                !strcmp(cfg.values[MDKR_INPUT_CONTROLLER_X].text, "b") &&
                !strcmp(cfg.values[MDKR_INPUT_CONTROLLER_LEFT_TRIGGER].text, "r") &&
                !strcmp(cfg.values[MDKR_INPUT_CONTROLLER_RIGHT_TRIGGER].text, "r") &&
                !strcmp(cfg.values[MDKR_INPUT_CONTROLLER_LEFT_SHOULDER].text, "z") &&
                !strcmp(cfg.values[MDKR_INPUT_CONTROLLER_RIGHT_SHOULDER].text, "z"));
