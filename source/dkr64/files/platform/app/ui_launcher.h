...
struct LauncherState {
    ...
    /* A ROM the PLAYER just handed us (picker, typed path or drop) has passed
     * its check this frame. The remembered ROM loaded at startup never sets
     * it: this means "somebody chose one", which is what the VR path treats
     * as "and now play it". Consumed by Launcher::draw. */
    bool romSelectionJustAccepted = false;
